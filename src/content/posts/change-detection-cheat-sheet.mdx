---
title: 'Angular Change Detection Cheat Sheet'
description: 'This article serves as a cheat sheet, covering Angular’s reactivity model—from Zone.js-based change detection to the more efficient Signals-based approach—optimizing performance with fine-grained updates.'
...
categories: ['Angular']
tags: ['Angular', 'Angular Signals', 'Change Detection']
draft: false
---
...
<Aside type="note">
  You can find the same cheat sheet, along with a visualization tool to
  experiment with different scenarios, on the
  [change-detection.guide](https://www.change-detection.guide/).
</Aside>
...
![global-targeted-mode](/assets/blog/change-detection-cheat-sheet/comparison.png)
...
![global-targeted-mode](/assets/blog/change-detection-cheat-sheet/global-targeted-mode.png)
